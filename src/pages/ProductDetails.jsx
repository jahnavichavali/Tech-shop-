...
const ProductDetails = () => {
    ...
    const reviews = [
        {
            id: 1,
            name: "Jahnavi Chavali",
            date: "4 Aug 2025",
            rating: 5,
            text: "Sound is awesome and as I expected, love it.",
            avatar: "https://t3.ftcdn.net/jpg/03/06/48/06/360_F_306480628_GQcab4I8yNs3n9RjBWcTMDqogfXFu6Y0.jpg"
        },
        {
            id: 2,
            name: "Ranesh Manchuri",
            date: "23 May 2024",
            rating: 5,
            text: "Very good and awesome product",
            avatar:"https://t4.ftcdn.net/jpg/06/04/07/83/240_F_604078332_fRvINZ9SkfL6jksQlkUCe7RpP5h6LGDc.jpg   "
        },
        {
            id: 3,
            name: "Phaneendra Guduru",
            date: "10 Dec 2023",
            rating: 5,
            text: "Very good and awesome product",
            avatar: "https://t3.ftcdn.net/jpg/01/57/21/46/240_F_157214616_EX2fuNJZzhm0PxBrPheO9EfkpGURDdLH.jpg"
        }
    ];
        ...
        <>
            <div className="d-flex bg-dark mx-5 mt-5 product-container">
                    ...
                    <div className="d-flex flex-column thumbnails">
                        {product.images && product.images.length > 0 ? (
                            product.images.map((img, index) => (
                                <img
                                    key={index}
                                    className="mb-2 border border-white product_details_small_image_width cursor-pointer p-2"
                                    src={img}
                ...
                <div className="product_details_right ms-5">
                    ...
                    {/* Offers */}
                    <h5 className="text-white mb-3 ">Offers And Discounts</h5>
                    <div className="d-flex font_size_product" style={{ gap: "0 20px" }}>
                        <p className="border border-white text-white fs-4 rounded-2 p-3 ">
