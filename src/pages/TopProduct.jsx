...
const TopProducts = () => {
  ...
  return (
    <div className="container-fluid bg-dark pb-5">
      <h1 className="text-center text-white p-4">Top Products</h1>

      {/* Category Buttons */}
      <div className="button-container text-center mb-10 mt-3">
        ...
        <div className="row justify-content-center gx-4 gy-4">
          {displayedProducts.map((product) => (
            <div key={product.id} className="col-lg-3 col-md-4 col-sm-6 col-12">
              <div className="card h-100 bg-dark border border-white text-white justify-center">
