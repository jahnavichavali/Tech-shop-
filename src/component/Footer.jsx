      ...
      <div className="container-fluid">
        <div className="row mb-10 mt-3">
          ...
          <div className="col-md-3 text-center">
            <h1 className="mb-4 headings" >Help</h1>
            <ul className="list-unstyled">
          ...
          {/* Column 3 */}
          <div className="col-md-3 text-center">
            <h1 className="ps-md-3 mb-4 headings">Policies</h1>
            <ul className="list-unstyled">
          ...
          {/* Column 4 */}
          <div className="col-md-3 text-center">
            <h3 className="ps-md-0 mb-4 headings">Company</h3>
            <ul className="list-unstyled">
        ...
        <div className="text-start mt-10">
          <div className="row">
            <div className="col-8">
              <p>2025 | All Right Reserved &copy;Jahnavi Chavali</p>
            </div>
